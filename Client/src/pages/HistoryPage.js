...
const HistoryPage = () => {
  ...
  useEffect(() => {
    TactApi.getAllExercises().then((data) => {
      setHistoryList(data);
      setIsLoading(false);
    });
  }, []);
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  <TableRow
                    hover
                    onClick={(event) =>
                      handleClick(event, row.basicInfo.exercise)
                    }
                    role="checkbox"
                    aria-checked={isItemSelected}
                    tabIndex={-1}
                    key={row.basicInfo.exercise}
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      padding="none"
                    >
                      {row.basicInfo.exercise}
                    </TableCell>
                    <TableCell align="left">
                      {row.basicInfo.dateCreated}
                    </TableCell>
                    <TableCell align="left">
                    ...
                    <TableCell align="left">
                      {row.overView.startLocation}
                    </TableCell>
                    <TableCell align="left">
                      {row.overView.endLocation}
                    </TableCell>
                    <TableCell align="left">{row.basicInfo.unit}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
