...
const UserInfo = (name, id, role) => {
    ...
    if(role === "pending"){
    return (<Typography key={id} align="left" noWrap="true">• UserName: {name} Role: {role} <IconButton><BlockIcon sx={{ color: red[500]}}/></IconButton><IconButton><CheckCircleIcon sx={{ color: green[500]}}/></IconButton></Typography>)
    }
